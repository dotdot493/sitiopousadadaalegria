	        ...
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	            ...
	            <div class="col-md-12 ftco-animate text-center">
	              <h1 class="mb-2">Consuma produto natural &amp; Viva saúde</h1>
	              <h2 class="subheading mb-4">Temos o melhor &amp; Produzimos com amor</h2>
	              <p><a href="#" class="btn btn-primary">Conenheça mais</a></p>
	            </div>
	        ...
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	            ...
	            <div class="col-sm-12 ftco-animate text-center">
	              <h1 class="mb-2">Frescos &amp; Orgânicos</h1>
    		...
    		<div class="row">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					...
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="shop.html">Geléias</a></h3>
    						<div class="d-flex">
    							<div class="pricing">
