    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="about.html" class="nav-link">Sobre Nós</a></li>
	...
	<section class="ftco-section ftco-cart">
			<div class="container">
                ...
                while ($row=mysqli_fetch_array($q)){		
                    echo("<tr><td>$row[cliente]</td><td>$row[dia]</td><td>$row[endereco]</td><td>$row[pedido]</td><td>R$ $row[total]</td><td><a href=deletecliente.php?cod=$row[cliente]><center></center</td></tr>"); 
                }
                ?>
