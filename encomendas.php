...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">LEGUMES  <BR>VERDURAS<BR>   OVOS CAIPIRA</a>
		  ...
		  <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item"><a href="https://coberturaeconimicsolar.000webhostapp.com/shop.html" class="nav-link">Pagina Inicial</a></li>
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
              	<a class="dropdown-item" href="https://coberturaeconimicsolar.000webhostapp.com/shop.html">Produtos</a>
              <a class="dropdown-item" href="https://coberturaeconimicsolar.000webhostapp.com/ionic/inicialcli1.php">Ofertas do Dia</a>
              	
              </div>
            </li>
	          <li class="nav-item active"><a href="https://coberturaeconimicsolar.000webhostapp.com/about.html" class="nav-link">Sobre Nós</a></li>
	          
	          <li class="nav-item"><a href="https://coberturaeconimicsolar.000webhostapp.com/contact.html" class="nav-link">Contato</a></li>
	          <li class="nav-item"><a target="_blank" href="https://br930.hostgator.com.br:2096/webmaillogout.cgi" class="nav-link">Webmail</a></li>
			  <li class="nav-item"><a target="_blank" target="_blank" href="https://coberturaeconimicsolar.000webhostapp.com/ionic/login.php" class="nav-link">Admin</a></li>
      ...
      <div class="container">
          ...
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Endereço: Primeria direita na saída para Cataguarino</span><br><br>
	...
	<title>Faça sua encomenda</title>

	<section class="section">
		<div class="container">
			<div class="columns is-centered">
				<div class="column is-half">
					<h1 class="title has-text-centered">Faça sua Encomenda</h1>
 
					<form method="post" action="sitiojsoninserir.php"enctype="multipart/form-data">
						<div class="field">
							<label class="label">Nome do Cliente</label>
							<div class="control">
								<input name="cliente" class="input" type="text" placeholder="Seu nome">
							</div>
						</div>
						...
						<div class="field">
							...
							<div class="control">
								<input type="text" name="telefone" class="input" placeholder="Seu Telefone">
							</div>
						</div>
						<div class="field">
							<div class="field">
								...
								<div class="control">
									<textarea name="endereco" class="textarea" placeholder="Deixe sua mensagem" maxlength="2000"></textarea>
								</div>
							</div>
						...
						<div class="field">
							<div class="field">
								<label class="label">Encomendas:</label>
								<div class="control">
									<textarea name="encomenda" class="textarea" placeholder="Deixe sua mensagem" maxlength="2000"></textarea>
								</div>
							</div>
						<div class="field">
							<label class="label">Total:</label>
							<div class="control">
								<input type="text" name="number" class="input" placeholder="Seu Telefone">
							</div>
						</div>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="about.html" class="py-2 d-block">Sobre Nós</a></li>
