...
<html lang="en">
 ...
 $q=mysqli_query($con, "SELECT * FROM tbpedidos"); 
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="#">Pedidos  do  Dia</a>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a target="_blank" href="exibirpedidos.php " class="nav-link">Encomendas</a></li>
	...
	<section class="ftco-section ftco-cart">
			<div class="container">
                ...
                while ($row=mysqli_fetch_array($q)){
                    ...
                    if($row["status"]=="recebido")$cor="#00BFFF";
