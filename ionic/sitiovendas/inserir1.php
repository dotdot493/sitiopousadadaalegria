		...
		<div class="container">
			<div class="columns is-centered">
				<div class="column is-half">
					<h1 class="title has-text-centered">Cadastrar novo Produto</h1>
 
					<form action="inserir2.php" method="post" enctype="multipart/form-data">
						<div class="field">
							<label class="label">Nome do Produto</label>
							<div class="control">
								<input name="produto" class="input" type="text" placeholder="Nome do Produto
						</div>
 
						<div class="field">
							<label class="label">Tipo</label>
							<div class="control">
								<input type="text" name="tipo" class="input" placeholder="Tipo de produto">
							</div>
							...
							<div class="field">
							<label class="label">Escolha Foto para Upload</label>
							<div class="control">
								<input type="hidden" name="MAX_FILE_SIZE" class="input" value="100000" placeholder="carregar foto">
								...
								<button  type= "submit" class="button is-link is-medium">Concluir</button>
							</div>
						</div>
					</form>
