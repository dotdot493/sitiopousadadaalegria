  ...
  <body class="goto-here">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
       ...
       <div class="collapse navbar-collapse" id="ftco-nav">
        ...
        $q=mysqli_query($con, "SELECT * FROM tbestoque where codigo=$_REQUEST[cod]"); 
		...
		<div class="container">
			<div class="columns is-centered">
				<div class="column is-half">
					<h1 class="title has-text-centered">Alterar Produto</h1>
 
					<form action="alterar2.php" method="post" enctype="multipart/form-data">
						<div class="field">
							<label class="label">Nome do Produto</label>
							<div class="control">
								<input type="text" name="produto" value="<?php echo $row["produto"]; ?>">
						</div>
						...
						<div class="field">
							...
							<div class="control">
								...
								<button  type= "submit" class="button is-link is-medium">Alterar</button>
							</div>
						</div>
					</form>
