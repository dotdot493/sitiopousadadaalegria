...
<html lang="en">
  ...
  <body class="goto-here">
	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
					    ...
					    <div class="col-md-5 pr-4 d-flex topper align-items-center text-lg-right">
						    <span class="text">PRODUTOS FRESCOS &amp; SEM AGROTÓXCOS</span>
					    </div>
				    </div>
			    </div>
		    </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="3">Area  Administrativa</a>
       ...
       <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item"><a href="https://sitiopousadadaalegria.com/ionic/inicial.php" class="nav-link">PAGINA INICIAL</a></li>
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
              	<a class="dropdown-item" href="https://sitiopousadadaalegria.com/ionic/inserir1.php">Produtos</a>
      ...
      $produto=$_POST['produto'];
        ...
        $sql = "INSERT INTO tbestoque(produto, tipo, preco)VALUES ('$produto', '$tipo', $preco)";
      ...
      <div class="container">
          ...
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Endere���o: Primeria direita na sa���da para Cataguarino</span><br><br>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="about.html" class="py-2 d-block">Sobre N���s</a></li>
